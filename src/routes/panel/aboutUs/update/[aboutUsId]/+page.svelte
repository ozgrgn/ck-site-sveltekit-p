					...
					<div class="flex flex-wrap my-4">
						...
						<div class="w-full lg:w-12/12 px-4">
							<div class="relative w-full mb-3">
								...
								<TextEditor
									bind:value={aboutUs.staffText.value}
									bind:incomingValue={aboutUs.staffText.value}
									placeholder={'Ekip Text'}
								/>
							</div>
						</div>
						...
						<div class="w-full lg:w-6/12 px-4">
							<div class="relative w-full mb-3">
								<label class="block text-blueGray-600 text-xs font-bold mb-2" for="grid-name">
									İkili Resim 2 (435x290)
								</label>
								<Image bind:value={aboutUs.image2.value} bind:isValid={aboutUs.image2.isValid} />
							</div>
						</div>
					</div>
